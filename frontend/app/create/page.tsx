    ...
    try {
      ...
      const imageBlob = await new Promise<Blob>((resolve, reject) => {
        canvasRef.current?.toBlob((blob) => {
          ...
          else reject(new Error("Falha ao capturar imagem do canvas"));
        }, 'image/png');
      });
      ...
      // Enviar para a API e aguardar a resposta
      const savedArt = await api.arts.create(formData);

      // Verificar se a arte foi salva
